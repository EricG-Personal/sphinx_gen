...
When the command sphinx-apidoc -o docs/ a_package is executed, both versions will create:

docs/a_package.rst
docs/a_package.sub_package.rst
modules.rst

However, the contents of docs/a_package.rst are different.
...
v1.6.6 does not generate these lines with the same command.